      ...
      <nav className="bg-black px-4 py-4">
        <div className="flex flex-wrap justify-evenly items-center mx-auto mt-2 relative">
          ...
          <Link to="/" className="flex items-center">
            <img
              className="w-8 rounded-full bg-transparent bg-darkblue bg-opacity-40"
              src="https://d154zarmrcpu4a.cloudfront.net/60fe828b-2ebf-4dd2-9b4d-d78f771b83cc.png"
              alt="Logo"
            />
          ...
          {/* Profile Section */}
          <div
            className="flex items-center gap-3 px-2 py-1.5 bg-darkblue bg-opacity-50 rounded-2xl relative cursor-pointer"
            onClick={toggleDropdown}
          >
            <div className="w-6 h-6 rounded-full overflow-hidden bg-gray-300 text-xs flex items-center justify-center font-semibold">
              {profileImageUrl ? (
            ...
            <img src="/down-arrow.png" className="w-4 h-4" alt="Dropdown arrow" />
            <div
              className={`bg-black2 ${
                isDropdownOpen ? "block" : "hidden"
              } p-4 w-48 absolute top-full mt-2 right-0 z-20 flex flex-col rounded-lg shadow-lg`}
            >
              <Link to="/profile" className="w-full text-left text-white py-2 px-4 hover:bg-darkblue rounded">
                Profile
              </Link>
